  ...
  return (
    ...
    >
      <rect
        ...
        width="21"
        height="48"
        fill="url(#patternNickRightStand)"
      />
      <defs>
        <pattern
          id="patternNickRightStand"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use
            xlinkHref="#imageNickRightStand"
            transform="scale(0.047619 0.0208333)"
          />
        </pattern>
        <image
          id="imageNickRightStand"
          width="21"
          height="48"
  ...
  return (
    ...
    >
      <rect
        ...
        width="25"
        height="47"
        fill="url(#patternNickRight1)"
      />
      <defs>
        <pattern
          id="patternNickRight1"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#imageNickRight1" transform="scale(0.04 0.0212766)" />
        </pattern>
        <image
          id="imageNickRight1"
          width="25"
  ...
  return (
    ...
    >
      <rect
        ...
        width="24"
        height="48"
        fill="url(#patternNickRight2)"
      />
      <defs>
        <pattern
          id="patternNickRight2"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use
            xlinkHref="#imageNickRight2"
