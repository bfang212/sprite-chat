  ...
  return (
    ...
    >
      <rect
        width="20"
        height="48"
        transform="matrix(-1 0 0 1 38 4)"
        fill="url(#patternKateLeftStand)"
      />
      <defs>
        <pattern
          id="patternKateLeftStand"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use
            xlinkHref="#imageKateLeftStand"
            transform="scale(0.05 0.0208333)"
          />
        </pattern>
        <image
          id="imageKateLeftStand"
          width="20"
          height="48"
    ...
    >
      ...
      <defs>
        <pattern
          ...
          height="1"
        >
          <use xlinkHref="#imageKateLeft1" transform="scale(0.04 0.0208333)" />
        </pattern>
        <image
          id="imageKateLeft1"
          width="25"
